...
for k in range(61):
        ...
        A0,A1=mo.gen_permute_matrix_zd(csp0,csp1)
        end_time = time.time()
        execution_time = float(end_time - start_time)*1000

        #print("ZDWNN model encryption:", execution_time, "mseconds")
        ...
        csu.set_query_data_zd(udata,PRIME)
        ...
        end_time = time.time()
        execution_time = float(end_time - start_time)*1000
        print("Tree inference time: ",eval_time)
        ...
        end_time = time.time()
        execution_time = float(end_time - start_time)*1000
        ZDWNN_totaltime.append(execution_time)

#print("ZDWNN Average time: ", sum(ZDWNN_totaltime)/len(ZDWNN_totaltime))
